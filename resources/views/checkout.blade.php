...
@section('content')
    <main class="max-w-3xl mx-auto px-6 py-20 text-slate-900">
        <div class="mb-12">
            <a href="{{ url('/event/1') }}" class="text-indigo-600 font-bold flex items-center gap-2 mb-6 hover:text-indigo-800 transition">
        ...
        <div class="grid grid-cols-1 gap-8">
            <div class="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm">
                ...
                <div class="flex gap-6 items-start">
                    <img src="{{ asset('template-amikomhub-share-mhs/assets/concert.png') }}" alt="Event" class="w-24 h-24 rounded-2xl object-cover">
                    <div>
    ...
    <div id="midtrans-overlay" class="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-50 hidden flex items-center justify-center p-6 text-slate-900">
        <div class="bg-white w-full max-w-sm rounded-[2rem] overflow-hidden shadow-2xl animate-bounce-in">
            ...
            <div class="p-8 text-center">
                ...
                <div class="mt-8 space-y-4">
                    <button onclick="window.location.href='{{ url('/my-ticket') }}'" class="w-full py-4 border-2 border-indigo-100 rounded-2xl flex justify-between items-center px-6 hover:border-indigo-600 transition group">
